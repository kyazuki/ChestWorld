...
public class ModLootTables {
  ...
  static {
    ...
    SPAWN_BONUS_CHEST = Pair.of("chestname.chestworld.bonus", LootTables.SPAWN_BONUS_CHEST);
    END_CITY_TREASURE = Pair.of("chestname.chestworld.endcity", LootTables.END_CITY_TREASURE);
    SIMPLE_DUNGEON = Pair.of("chestname.chestworld.dungeon", LootTables.SIMPLE_DUNGEON);
    VILLAGE_WEAPONSMITH = Pair.of("chestname.chestworld.village.weaponsmith", LootTables.VILLAGE_WEAPONSMITH);
    VILLAGE_TOOLSMITH = Pair.of("chestname.chestworld.village.toolsmith", LootTables.VILLAGE_TOOLSMITH);
    VILLAGE_ARMORER = Pair.of("chestname.chestworld.village.armorer", LootTables.VILLAGE_ARMORER);
    VILLAGE_CARTOGRAPHER = Pair.of("chestname.chestworld.village.cartographer", LootTables.VILLAGE_CARTOGRAPHER);
    VILLAGE_MASON = Pair.of("chestname.chestworld.village.mason", LootTables.VILLAGE_MASON);
    VILLAGE_SHEPHERD = Pair.of("chestname.chestworld.village.shepherd", LootTables.VILLAGE_SHEPHERD);
    VILLAGE_BUTCHER = Pair.of("chestname.chestworld.village.butcher", LootTables.VILLAGE_BUTCHER);
    VILLAGE_FLETCHER = Pair.of("chestname.chestworld.village.fletcher", LootTables.VILLAGE_FLETCHER);
    VILLAGE_FISHER = Pair.of("chestname.chestworld.village.fisher", LootTables.VILLAGE_FISHER);
    VILLAGE_TANNERY = Pair.of("chestname.chestworld.village.tannery", LootTables.VILLAGE_TANNERY);
    VILLAGE_TEMPLE = Pair.of("chestname.chestworld.village.temple", LootTables.VILLAGE_TEMPLE);
    VILLAGE_DESERT_HOUSE = Pair.of("chestname.chestworld.village.desert", LootTables.VILLAGE_DESERT_HOUSE);
    VILLAGE_PLAINS_HOUSE = Pair.of("chestname.chestworld.village.plains", LootTables.VILLAGE_PLAINS_HOUSE);
    VILLAGE_TAIGA_HOUSE = Pair.of("chestname.chestworld.village.taiga", LootTables.VILLAGE_TAIGA_HOUSE);
    VILLAGE_SNOWY_HOUSE = Pair.of("chestname.chestworld.village.snowy", LootTables.VILLAGE_SNOWY_HOUSE);
    VILLAGE_SAVANNA_HOUSE = Pair.of("chestname.chestworld.village.savanna", LootTables.VILLAGE_SAVANNA_HOUSE);
    ABANDONED_MINESHAFT = Pair.of("chestname.chestworld.mineshaft", LootTables.ABANDONED_MINESHAFT);
    //NETHER_BRIDGE = Pair.of("chestname.chestworld.nether_fortress", LootTables.NETHER_BRIDGE);
    STRONGHOLD_LIBRARY = Pair.of("chestname.chestworld.stronghold.library", LootTables.STRONGHOLD_LIBRARY);
    STRONGHOLD_CROSSING = Pair.of("chestname.chestworld.stronghold.crossing", LootTables.STRONGHOLD_CROSSING);
    STRONGHOLD_CORRIDOR = Pair.of("chestname.chestworld.stronghold.corridor", LootTables.STRONGHOLD_CORRIDOR);
    DESERT_PYRAMID = Pair.of("chestname.chestworld.pyramid", LootTables.DESERT_PYRAMID);
    JUNGLE_TEMPLE = Pair.of("chestname.chestworld.temple", LootTables.JUNGLE_TEMPLE);
    IGLOO_CHEST = Pair.of("chestname.chestworld.igloo", LootTables.IGLOO_CHEST);
    WOODLAND_MANSION = Pair.of("chestname.chestworld.mansion", LootTables.WOODLAND_MANSION);
    UNDERWATER_RUIN_SMALL = Pair.of("chestname.chestworld.underwater.small", LootTables.UNDERWATER_RUIN_SMALL);
    UNDERWATER_RUIN_BIG = Pair.of("chestname.chestworld.underwater.big", LootTables.UNDERWATER_RUIN_BIG);
    BURIED_TREASURE = Pair.of("chestname.chestworld.buried", LootTables.BURIED_TREASURE);
    SHIPWRECK_MAP = Pair.of("chestname.chestworld.shipwreck.map", LootTables.SHIPWRECK_MAP);
    SHIPWRECK_SUPPLY = Pair.of("chestname.chestworld.shipwreck.supply", LootTables.SHIPWRECK_SUPPLY);
    SHIPWRECK_TREASURE = Pair.of("chestname.chestworld.shipwreck.treasure", LootTables.SHIPWRECK_TREASURE);
    PILLAGER_OUTPOST = Pair.of("chestname.chestworld.outpost", LootTables.PILLAGER_OUTPOST);
    BASTION_TREASURE = Pair.of("chestname.chestworld.bastion.treasure", LootTables.BASTION_TREASURE);
    BASTION_OTHER = Pair.of("chestname.chestworld.bastion.treasure", LootTables.BASTION_OTHER);
    BASTION_BRIDGE = Pair.of("chestname.chestworld.bastion.treasure", LootTables.BASTION_BRIDGE);
    BASTION_HOGLIN_STABLE = Pair.of("chestname.chestworld.bastion.treasure", LootTables.BASTION_HOGLIN_STABLE);
    RUINED_PORTAL = Pair.of("chestname.chestworld.bastion.treasure", LootTables.RUINED_PORTAL);
